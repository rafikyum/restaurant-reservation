...
router.post("/new", isLoggedIn, async (req, res) => {
  ...
  try {
    ...
    req.flash("success", "successfull reservation");
    res.statusCode = 302;
    res.setHeader("Location", "/reservations/choice");
    return res.end();
  } catch (error) {
...
router.put("/update/:id", isLoggedIn, async (req, res) => {
  try {
    ...
    req.flash("success", "reservation has been updated");
    res.statusCode = 302;
    res.setHeader("Location", "/reservations/choice");
    return res.end();
  } catch (error) {
...
router.delete("/delete/:id", isLoggedIn, async (req, res) => {
  try {
    ...
    */
    ...
    req.flash("success", "successfull cancellation");
    res.statusCode = 302;
    res.setHeader("Location", "/reservations/choice");
    return res.end();
  } catch (error) {
